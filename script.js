function enterSite(){
  ...
  $("#dimmed-bg").css("transform","translate(0)");   //in above_fold.scss by default it is translated off the screen
                                                     // & here we translate it to 0 which will reset it back to its default position which is dmmed background
...
function openForm(){
  $("#register-side-bar").css("transform","translate(-560px)");
